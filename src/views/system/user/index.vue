...
const queryFormRef = ref(ElForm);//查询表单引用
const userFormRef = ref(ElForm);//用户表单引用

const deptOptions = ref<OptionType[]>();//部门下拉选项
const roleOptions = ref<OptionType[]>();//角色下拉选项
...
async function handleOpenDialog(id?: number) {
  dialog.visible = true;
  roleOptions.value = await RoleAPI.getOptions();// 加载角色下拉数据源
  deptOptions.value = await DeptAPI.getOptions();// 加载部门下拉数据源
